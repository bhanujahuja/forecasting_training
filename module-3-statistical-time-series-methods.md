...
1. Choose a time series dataset from earlier or use your own.
2. Test for stationarity (`adfuller`).
3. Fit and tune ARIMA/SARIMA/Prophet.
4. Forecast future values. Visualize and interpret results.
5. Compare these to basic (Module 2) baseline forecasts.
